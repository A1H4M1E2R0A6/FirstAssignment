...
import "./styles.css";
// import  {profile1,profile2,profile3} from "./src/img";
...
ReactDOM.render(
  <div>
    <Post 
      ...
      // // text= "Exploring new horizons and embracing change. Life's greatest adventures often begin outside of our comfort zones. 🌍✨ #AdventureAwaits #EmbraceChange #ExploreTheUnknown"
       />
    <Post
      // profileImg={profile2}
      name="Farhan"
